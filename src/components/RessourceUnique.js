// import "../styles/ressource-unique.css";
// import { Box } from "@mui/system";
// import Publication from "./Publication";

// function RessourceUnique() {
//   return (
//     // <div className="ressource-card">
//     //   <h2>{ressource.titre}</h2>
//     //   <p>
//     //     Mis en ligne le{" "}
//     //     {new Date(ressource.dateCreation).toLocaleString("fr-FR", {
//     //       day: "numeric",
//     //       month: "numeric",
//     //       year: "2-digit",
//     //       hour: "numeric",
//     //       minute: "numeric",
//     //     })}{" "}
//     //     par {ressource.idUtilisateur}
//     //   </p>
//     //   <div>
//     //     <img src={ressource.contenu} alt={ressource.titre} />
//     //   </div>
//     //   <p>{ressource.contenu}</p>
//     //   <button onClick={pageRessourceUnique}>Voir plus</button>
//     // </div>
...
// export default RessourceUnique;
